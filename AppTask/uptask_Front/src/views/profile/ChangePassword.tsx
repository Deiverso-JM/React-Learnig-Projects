...
import { NewCurrentPasswordForm } from "@/types/index";

export default function ChangePasswordView() {
  const initialValues : NewCurrentPasswordForm = {
    current_password: "",
    password: "",
  ...
  const {
    ...
    formState: { errors },
    reset,
  } = useForm<NewCurrentPasswordForm>({ defaultValues: initialValues });
  ...
  const handleChangePassword = (formData: NewCurrentPasswordForm) => mutateAsync(formData);
