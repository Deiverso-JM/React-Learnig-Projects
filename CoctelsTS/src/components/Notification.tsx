...
export default function Notification() {
 ...
 const notification =  useAppStores(state => state.notification)
 const closewNotification =  useAppStores(state => state.closewNotification)
